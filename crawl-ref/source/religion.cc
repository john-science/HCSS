...
string god_name(god_type which_god, bool long_name)
{
    ...
    case GOD_VEHUMET:       return "Nath-Horthath";
    case GOD_OKAWARU:       return "Ghatanothoa";
    case GOD_MAKHLEB:       return "Paimon";
    case GOD_SIF_MUNA:      return "Karakal";
    case GOD_TROG:          return "Ammut";
    ...
    case GOD_RU:            return "Yig";
    case GOD_PAKELLAS:      return "Valak";
    case GOD_USKAYAW:       return "Lamashtu";
    case GOD_HEPLIAKLQANA:  return "Pazuzu";
    case GOD_WU_JIAN:       return "Sobek";
