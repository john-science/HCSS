...
"Note: `Zot` totally highlights in e.g. the items `rune of Zot` and `Heart of Zot`. Not worth fixing.
syn keyword desOrientation Demon Dis Geh Coc Tar Zot Forest Abyss Pan Zig Lab Bazaar Trove Sewer Ossuary
...
syn match desBranch contained /demon\|dis\|geh\|coc\|tar\|zot\|forest\|abyss\|pan\|zig\|lab\|bazaar\|trove\|sewer\|ossuary/
syn match desBranch contained /bailey\|icecv\|volcano\|wizlab/

syn match desBranchname contained /dungeon\|depths\|temple\|orcish_hells\|elven_hells\|lair\|swamp\|shoals/
syn match desBranchname contained /snakes\|spiders\|slime_pits\|vaults\|hell_of_blades\|crypt\|tomb/
