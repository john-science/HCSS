...
enum branch_type                // you.where_are_you
{
    ...
    BRANCH_COCYTUS,
    BRANCH_TARTARUS,
    BRANCH_FIRST_DEMON = BRANCH_DIS,
    BRANCH_LAST_DEMON = BRANCH_TARTARUS,
    BRANCH_ZOT,
    BRANCH_FOREST,
    BRANCH_ABYSS,
    BRANCH_PANDEMONIUM,
...
enum game_chapter
{
    ...
    CHAPTER_ORB_HUNTING, // entered the dungeon but not found the heart yet
    CHAPTER_ESCAPING, // ascending with the heart
    CHAPTER_ANGERED_PANDEMONIUM, // moved the heart without picking it up
    NUM_CHAPTERS,
};
...
enum game_type
{
    ...
    GAME_TYPE_NORMAL, //'Normal' mode for this build is hell crawl
    GAME_TYPE_TUTORIAL,
    GAME_TYPE_ARENA,
    GAME_TYPE_SPRINT,
    GAME_TYPE_HINTS,
