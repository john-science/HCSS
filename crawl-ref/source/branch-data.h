...
const Branch branches[NUM_BRANCHES] =
{
    ...
    { BRANCH_SLIME, BRANCH_DEPTHS, 1, 3, 5, 17,
    ...
    { BRANCH_CRYPT, BRANCH_DEPTHS, 1, 3, 3, 19,
      BFLAG_DANGEROUS_END,
    ...
    { BRANCH_TOMB, BRANCH_ZOT, 2, 4, 3, 21,
    ...
    { BRANCH_VESTIBULE, BRANCH_DEPTHS, 2, 4, 1, 27,
      BFLAG_NO_ITEMS,
      DNGN_ENTER_DEMON, DNGN_EXIT_DEMON, NUM_FEATURES,
    ...
    { BRANCH_DIS, BRANCH_VESTIBULE, 1, 1, 7, 28,
      ...
      DNGN_ENTER_DIS, DNGN_ENTER_DEMON, DNGN_ENTER_DEMON,
    ...
    { BRANCH_GEHENNA, BRANCH_VESTIBULE, 1, 1, 7, 28,
      BFLAG_NO_ITEMS | BFLAG_DANGEROUS_END,
      DNGN_ENTER_GEHENNA, DNGN_ENTER_DEMON, DNGN_ENTER_DEMON,
      "Gehenna", "Gehenna", "Geh",
      nullptr,
      BROWN, RED,
      'G', { RUNE_GEHENNA }, 0 },
    ...
    { BRANCH_COCYTUS, BRANCH_VESTIBULE, 1, 1, 7, 28,
      BFLAG_NO_ITEMS | BFLAG_DANGEROUS_END,
      DNGN_ENTER_COCYTUS, DNGN_ENTER_DEMON, DNGN_ENTER_DEMON,
      "Cocytus", "Cocytus", "Coc",
      nullptr,
      LIGHTBLUE, LIGHTCYAN,
      'X', { RUNE_COCYTUS }, 0 },
    ...
    { BRANCH_TARTARUS, BRANCH_VESTIBULE, 1, 1, 7, 28,
      BFLAG_NO_ITEMS | BFLAG_DANGEROUS_END,
      DNGN_ENTER_TARTARUS, DNGN_ENTER_DEMON, DNGN_ENTER_DEMON,
    ...
    { BRANCH_ABYSS, BRANCH_DEPTHS, 1, 3, 5, 24,
    ...
    { BRANCH_ZIGGURAT, BRANCH_ZOT, 1, 3, 27, 27,
      BFLAG_NO_XLEV_TRAVEL | BFLAG_NO_ITEMS,
