...
// dummy for recolouring
{
    ...
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS | M_NO_SKELETON | M_NO_POLY_TO
        | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_FORMICID, MONS_FORMICID, MH_UNDEAD, 40,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_ENTROPY_WEAVER, MONS_ENTROPY_WEAVER, MH_DEMONIC, 60,
...
{ // one vault + player transform (Vp ability)
    MONS_VAMPIRE_BEHOLDER, 'b', MAGENTA, "vampire beholder",
    M_SEE_INVIS | M_WARM_BLOOD | M_BATTY | M_NO_POLY_TO | M_FLIES,
    MR_NO_FLAGS,
    8, MONS_BEHOLDER, MONS_VAMPIRE_BEHOLDER, MH_UNDEAD, 10,
    { {AT_BITE, AF_VAMPIRIC, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 105,
    1, 14, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_ANIMAL, HT_LAND, 30, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BEHOLDER,
    {TILEP_MONS_VAMPIRE_BEHOLDER}, TILE_ERROR
},

{
    MONS_FIRE_BEHOLDER, 'b', RED, "fire beholder",
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_BATTY | M_FLIES,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_VUL_WATER,
    8, MONS_BEHOLDER, MONS_FIRE_BEHOLDER, MH_DEMONIC, 10,
    { {AT_BITE, AF_FIRE, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 225,
    1, 14, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_ANIMAL, HT_LAND, 30, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BEHOLDER,
    {TILEP_MONS_FIRE_BEHOLDER}, TILE_ERROR
},

{
    ...
    6, MONS_BENNU, MONS_BENNU, MH_UNDEAD, 140,
...
// centaurs ('c')
{
    ...
    MR_NO_FLAGS,
    10, MONS_CENTAUR, MONS_CENTAUR, MH_UNDEAD, 20,
...

{
    ...
    MR_NO_FLAGS,
    12, MONS_CENTAUR, MONS_CENTAUR, MH_UNDEAD, 40,
...

{
    ...
    M_WARM_BLOOD | M_ARCHER | M_SPEAKS,
    MR_NO_FLAGS,
    9, MONS_YAKTAUR, MONS_YAKTAUR, MH_UNDEAD, 40,
...

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_ARCHER | M_SPEAKS,
    MR_NO_FLAGS,
    9, MONS_YAKTAUR, MONS_YAKTAUR, MH_UNDEAD, 60,
...

{
    ...
    MR_NO_FLAGS,
    8, MONS_FAUN, MONS_FAUN, MH_DEMONIC, 40,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_FAUN, MONS_SATYR, MH_DEMONIC, 40,
...
// elves ('e')
{
    ...
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 360,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_UNDEAD, 80,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_UNDEAD, 120,
...

{
    ...
    MR_NO_FLAGS,
    30, MONS_ELF, MONS_ELF, MH_UNDEAD, 100,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_ELF, MONS_ELF, MH_UNDEAD, 40,
...

{
    ...
    MR_NO_FLAGS,
    15, MONS_ELF, MONS_ELF, MH_UNDEAD | MH_EVIL, 80,
...

{
    ...
    MR_NO_FLAGS,
    20, MONS_ELF, MONS_ELF, MH_UNDEAD | MH_EVIL, 100,
...

{
    ...
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
    17, MONS_ELF, MONS_ELF, MH_UNDEAD, 120,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 630,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    8, MONS_ELF, MONS_ELF, MH_UNDEAD, 120,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_VINE_STALKER, MONS_VINE_STALKER, MH_UNDEAD, 40,
...
{
    MONS_RESTLESS_BONES, 'g', LIGHTGREY, "restless bones",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GOBLIN, MONS_GOBLIN, MH_UNDEAD, 0,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 40,
    0, 12, MST_NO_SPELLS, CE_CLEAN, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_MISC,
    {TILEP_MONS_SKELETON_SMALL}, TILE_CORPSE_GOBLIN
},
...
{
    MONS_RESTLESS_FLESH, 'g', BROWN, "restless flesh",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_GOBLIN, MONS_HOBGOBLIN, MH_UNDEAD, 0,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 55,
    2, 10, MST_NO_SPELLS, CE_CLEAN, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_UNDEAD, 10,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 195,
...

{
    ...
    MR_NO_FLAGS,
    14, MONS_BOGGART, MONS_BOGGART, MH_DEMONIC, 40,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 200,
...
{ // Another dummy monster.
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_DWARF, MONS_DWARF, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 275,
...

{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_BLOOD_SCENT,
    mrd(MR_RES_ELEC, 3),
    12, MONS_HOUND, MONS_RAIJU, MH_DEMONIC, 20,
...
// spriggans ('i')
{
    ...
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_UNDEAD, 60,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 245,
...
{   // both the guy and his ride as one monster
    ...
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_UNDEAD, 100,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_UNDEAD, 120,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 540,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_UNDEAD, 140,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 490,
...

{
    ...
    10, MONS_DRAKE, MONS_DEATH_DRAKE, MH_UNDEAD, 40,
    { {AT_BITE, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 765,
...

{
    ...
    M_WARM_BLOOD | M_FLIES,
    MR_NO_FLAGS,
    15, MONS_WYVERN, MONS_WYVERN, MH_DEMONIC, 20,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 275,
...
// merfolk ('m')
{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    4, MONS_MERFOLK, MONS_MERFOLK, MH_UNDEAD, 40,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    13, MONS_MERFOLK, MONS_MERFOLK, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 780,
...

{
    ...
    M_WARM_BLOOD | M_ARCHER | M_DONT_MELEE | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_MERFOLK, MONS_MERFOLK, MH_UNDEAD, 60,
    { {AT_HIT, AF_PLAIN, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 780,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_NO_FLAGS,
    8, MONS_MERFOLK, MONS_MERFOLK, MH_UNDEAD, 80,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 630,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_UNDEAD, 60,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_WATER_NYMPH, MONS_WATER_NYMPH, MH_DEMONIC, 100,
...
// rotting monsters ('n')
{
    ...
    6, 390,
    1, 9, MST_BOG_BODY, CE_NOXIOUS, S_MOAN,
...

{
    ...
    14, 1470,
    4, 10, MST_NO_SPELLS, CE_NOXIOUS, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// orcs ('o')
{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_UNDEAD, 0,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 70,
    2, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_ORC, MONS_ORC, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 150,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    16, MONS_ORC, MONS_ORC, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 280,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    9, MONS_ORC, MONS_ORC, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 675,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    11, MONS_ORC, MONS_ORC, MH_UNDEAD, 60,
...

{
    ...
    MR_NO_FLAGS,
    12, MONS_ORC, MONS_ORC, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 315,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_ORC, MONS_ORC, MH_UNDEAD, 60,
...

{
    ...
    mrd(MR_RES_FIRE, 3),
    15, MONS_ORC, MONS_LAVA_ORC, MH_UNDEAD, 0,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 70,
...
// humans ('p')
{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    mrd(MR_RES_FIRE, 3),
    10, MONS_HUMAN, MONS_HUMAN, MH_DEMONIC | MH_EVIL, 40,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
...

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_DEMONIC | MH_EVIL, 80,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 60,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 400,
    2, 13, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 520,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 60,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 495,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_SHAPESHIFTER, MONS_SHAPESHIFTER, MH_DEMONIC, 40,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
...

{
    ...
    M_NO_SKELETON | M_NO_ZOMBIE,
    MR_NO_FLAGS,
    10, MONS_SHAPESHIFTER, MONS_GLOWING_SHAPESHIFTER, MH_DEMONIC, 80,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    0, 10, MST_NO_SPELLS, CE_MUTAGEN, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD | M_FAST_REGEN | M_NO_POLY_TO
        | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    17, MONS_HUMAN, MONS_KILLER_KLOWN, MH_DEMONIC, 160,
...
{ // dummy... literally; single vault
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_GNOME, MONS_GNOME, MH_UNDEAD, 10,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 105,
    2, 12, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    20, MONS_SPIDER, MONS_ORB_SPIDER, MH_DEMONIC, 40,
...

{
    ...
    25, MONS_CRAB, MONS_PLUTONIUM_CRAB, MH_DEMONIC, 40,
...
// from those below. beware!
{
    ...
    MR_NO_FLAGS,
    6, MONS_UGLY_THING, MONS_UGLY_THING, MH_DEMONIC, 40,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 660,
...

{
    ...
    M_WARM_BLOOD | M_HERD | M_NO_GEN_DERIVED | M_GHOST_DEMON,
    MR_NO_FLAGS,
    10, MONS_UGLY_THING, MONS_VERY_UGLY_THING, MH_DEMONIC, 40,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 990,
...

{
    ...
    MR_NO_FLAGS,
    8, MONS_TYRANT_LEECH, MONS_TYRANT_LEECH, MH_DEMONIC, 40,
...
// small abominations ('x')
{
    ...
    MR_NO_FLAGS,
    12, MONS_UNSEEN_HORROR, MONS_UNSEEN_HORROR, MH_DEMONIC, 20,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
...

{
    ...
    18, MONS_MOTH, MONS_GHOST_MOTH, MH_UNDEAD, 100,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    13, MONS_FROG, MONS_BLINK_FROG, MH_UNDEAD, 40,
...
// eyes ('G')
{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
    6, MONS_FLOATING_EYE, MONS_FLOATING_EYE, MH_DEMONIC, 10,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 165,
...

{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
    10, MONS_FLOATING_EYE, MONS_EYE_OF_DRAINING, MH_DEMONIC, 60,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
...

{
    ...
    MR_NO_FLAGS,
    13, MONS_GLOWING_ORANGE_BRAIN, MONS_GLOWING_ORANGE_BRAIN, MH_DEMONIC, 100,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
...

{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_RES_POISON,
    13, MONS_FLOATING_EYE, MONS_GREAT_ORB_OF_EYES, MH_DEMONIC, 120,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 660,
...

{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
    14, MONS_FLOATING_EYE, MONS_SHINING_EYE, MH_DEMONIC, 100,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
...

{
    ...
    MR_NO_FLAGS,
    17, MONS_FLOATING_EYE, MONS_GOLDEN_EYE, MH_DEMONIC, 60,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 120,
...
// Mutant beasts - variable traits
{
    ...
    MR_NO_FLAGS,
    11, MONS_MUTANT_BEAST, MONS_MUTANT_BEAST, MH_DEMONIC, -3,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 825,
...
// kobolds ('K')
{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_KOBOLD, MONS_KOBOLD, MH_UNDEAD, 0,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 35,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    7, MONS_KOBOLD, MONS_BIG_KOBOLD, MH_UNDEAD, 20,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    18, MONS_KOBOLD, MONS_KOBOLD, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 390,
...
// mummies ('M')
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 195,
    3, 6, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 455,
    6, 9, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1950,
    10, 6, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
    8, 7, MST_MUMMY_PRIEST, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 8, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// nagas ('N')
{
    ...
    MR_RES_POISON,
    13, MONS_NAGA, MONS_NAGA, MH_UNDEAD, 40,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
    14, MONS_NAGA, MONS_NAGA, MH_UNDEAD, 60,
...

{
    ...
    MR_RES_POISON,
    14, MONS_NAGA, MONS_NAGA, MH_UNDEAD, 80,
...

{
    ...
    MR_RES_POISON,
    11, MONS_NAGA, MONS_NAGA, MH_UNDEAD, 80,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
    15, MONS_NAGA, MONS_NAGA, MH_UNDEAD, 140,
...
// ogres ('O')
{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    9, MONS_OGRE, MONS_OGRE, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 275,
...
// that they wield two weapons... I'm raising their xp modifier. - bwr
{
    ...
    M_WARM_BLOOD | M_TWO_WEAPONS | M_SPEAKS,
    MR_NO_FLAGS,
    15, MONS_OGRE, MONS_TWO_HEADED_OGRE, MH_UNDEAD, 40,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    16, MONS_OGRE, MONS_OGRE, MH_UNDEAD, 80,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    3, 7, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
// tengu ('Q')
{
    ...
    MR_NO_FLAGS,
    10, MONS_TENGU, MONS_TENGU, MH_UNDEAD, 20,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES,
    MR_NO_FLAGS,
    13, MONS_TENGU, MONS_TENGU, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 10}, {AT_PECK, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
       AT_NO_ATK },
    7, 315,
...

{
    ...
    MR_NO_FLAGS,
    13, MONS_TENGU, MONS_TENGU, MH_UNDEAD, 40,
...

{
    ...
    MR_NO_FLAGS,
    13, MONS_TENGU, MONS_TENGU, MH_UNDEAD, 60,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES,
    MR_NO_FLAGS,
    13, MONS_TENGU, MONS_ELEVENGU, MH_DEMONIC, 60,
...
// trolls ('T')
{
    ...
    MR_NO_FLAGS,
    10, MONS_TROLL, MONS_TROLL, MH_UNDEAD, 20,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN,
    MR_RES_FIRE | MR_RES_COLD,
    10, MONS_TROLL, MONS_IRON_TROLL, MH_UNDEAD, 100,
...

{
    ...
    MR_NO_FLAGS,
    9, MONS_TROLL, MONS_DEEP_TROLL, MH_UNDEAD, 40,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_TROLL, MONS_DEEP_TROLL, MH_UNDEAD, 40,
    { {AT_BITE, AF_PLAIN, 27}, {AT_CLAW, AF_PLAIN, 20},
      {AT_CLAW, AF_PLAIN, 20}, AT_NO_ATK },
    12, 480,
...

{
    ...
    M_WARM_BLOOD | M_SEE_INVIS | M_UNBLINDABLE | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_TROLL, MONS_DEEP_TROLL, MH_UNDEAD, 40,
    { {AT_BITE, AF_PLAIN, 27}, {AT_CLAW, AF_PLAIN, 20},
      {AT_CLAW, AF_PLAIN, 20}, AT_NO_ATK },
    12, 480,
...
// vampires ('V')
{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    6, 330,
    10, 10, MST_VAMPIRE, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    10, 550,
    12, 10, MST_VAMPIRE_MAGE, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_CLAW, AF_VAMPIRIC, 27}, {AT_CLAW, AF_VAMPIRIC, 27}, AT_NO_ATK,
       AT_NO_ATK },
    10, 650,
    10, 10, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
...
{ // dummy genus monster, but also used for removed monsters
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 10,
    0, 0, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// dangerous, but still come out at 200+ XP
{
    ...
    7, 385,
    3, 13, MST_PHANTASMAL_WARRIOR, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    7, 385,
    0, 12, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 605,
    0, 14, MST_FLAYED_GHOST, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    13, 195,
    0, 13, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    MR_NO_FLAGS,
    20, MONS_ORB_GUARDIAN, MONS_ORB_GUARDIAN, MH_DEMONIC, 120,
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 825,
...

{
    ...
    15, MONS_ORB_GUARDIAN, MONS_DEV_FAVORITE, MH_DEMONIC, 120,
...
// yaks, sheep, elephants, and other beasts ('Y')
{
    ...
    M_WARM_BLOOD | M_HERD,
    MR_NO_FLAGS,
    10, MONS_DREAM_SHEEP, MONS_DREAM_SHEEP, MH_DEMONIC, 30,
    { {AT_BITE, AF_PLAIN, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 220,
...

{
    ...
    M_WARM_BLOOD,
    MR_RES_PETRIFY,
    8, MONS_YAK, MONS_CATOBLEPAS, MH_DEMONIC, 100,
...

{
    ...
    13, MONS_ICE_BEAST, MONS_ICE_BEAST, MH_DEMONIC, 20,
...
// or else are chosen randomly
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 75,
    0, 4, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_BRAINLESS, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_MISC,
    {TILEP_MONS_ZOMBIE_SMALL}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
    8, 5, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_BRAINLESS, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_MISC,
...
// water monsters
{
    ...
    mrd(MR_RES_ELEC, 3),
    19, MONS_ELECTRIC_EEL, MONS_ELECTRIC_EEL, MH_NATURAL | MH_DEMONIC, 10,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 165,
...
// Dummy monster for recolouring.
{
    ...
    MR_NO_FLAGS,
    10, MONS_OCTOPODE, MONS_OCTOPODE, MH_UNDEAD, 10,
...
// lava monsters
{
    ...
    17, MONS_SNAKE, MONS_LAVA_SNAKE, MH_NATURAL | MH_DEMONIC, 10,
...

{
    ...
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
    10, MONS_NAGA, MONS_SALAMANDER, MH_UNDEAD, 40,
    { {AT_HIT, AF_FIRE, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 640,
    5, 7, MST_NO_SPELLS, CE_CLEAN, S_MOAN,
...

{
    ...
    M_WARM_BLOOD,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
    10, MONS_NAGA, MONS_SALAMANDER, MH_UNDEAD, 60,
    { {AT_HIT, AF_FIRE, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
    7, 7, MST_SALAMANDER_MYSTIC, CE_CLEAN, S_MOAN,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, SWIM_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA,
...
// Semi-unique humans ('@')
{
    ...
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_DEMONIC, 100,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 1500,
...

{
    ...
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 100,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 1500,
...
// gargoyles ('9')
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 270,
    18, 6, MST_GARGOYLE, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 520,
    22, 4, MST_SPLINTER_BREATH, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED_TAILED,
...

{
    ...
    { {AT_HIT, AF_FIRE, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 315,
    14, 7, MST_MOLTEN_GARGOYLE, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED_TAILED,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 250,
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_BRAINLESS, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_ORB,
...

{
    ...
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_ORB_OF_FIRE, TVARY_RANDOM}, TILE_ERROR
},
...
// "A"ngels.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK,
       AT_NO_ATK },
    19, 1520,
    15, 28, MST_MENNAS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...
// "c"entaurs.
{
    ...
    MR_NO_FLAGS,
    18, MONS_CENTAUR, MONS_CENTAUR, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 720,
...
// "e"lves
{
    ...
    MR_NO_FLAGS,
    15, MONS_ELF, MONS_ELF, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 360,
    2, 9, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    15, MONS_ELF, MONS_ELF, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 240,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    16, MONS_ELF, MONS_ELF, MH_UNDEAD, 80,
    { {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 800,
...
// "F"rogs.
{
    ...
    MR_NO_FLAGS,
    12, MONS_FROG, MONS_HUMAN, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 390,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    19, MONS_GNOLL, MONS_GNOLL, MH_UNDEAD, 10,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 400,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    18, MONS_DWARF, MONS_DWARF, MH_UNDEAD, 120,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1200,
...
// Spr"i"ggans.
{
    ...
    MR_NO_FLAGS,
    20, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_UNDEAD, 100,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 990,
...

{
    ...
    MR_NO_FLAGS,
    35, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_UNDEAD, 160,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 975,
...
// "K"obolds.
{
    ...
    MR_NO_FLAGS,
    40, MONS_KOBOLD, MONS_KOBOLD, MH_UNDEAD, 10,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_UNIQUE | M_MALE,
    MR_NO_FLAGS,
    32, MONS_KOBOLD, MONS_BIG_KOBOLD, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 390,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 2430,
    10, 6, MST_KHUFU, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// "m"erfolk.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_UNDEAD, 140,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1520,
...
// "N"agas.
{
    ...
    MR_RES_POISON,
    27, MONS_NAGA, MONS_NAGA, MH_UNDEAD, 120,
...
// "O"gres.
{
    ...
    MR_NO_FLAGS,
    50, MONS_OGRE, MONS_OGRE, MH_UNDEAD, 60,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 540,
    3, 7, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
// "o"rcs.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 315,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 675,
    2, 13, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_UNIQUE | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    12, MONS_ORC, MONS_ORC, MH_UNDEAD, 60,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 600,
...

{
    ...
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_UNDEAD, 80,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1980,
...
// Tengu.
{
    ...
    MR_RES_TORNADO,
    20, MONS_TENGU, MONS_TENGU, MH_UNDEAD, 140,
...
// Rakshasas and demons.
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 880,
    10, 5, MST_AZRAEL, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1440,
    10, 14, MST_MARA, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// "T"rolls.
{
    ...
    MR_NO_FLAGS,
    25, MONS_TROLL, MONS_TROLL, MH_UNDEAD, 60,
    { {AT_BITE, AF_PLAIN, 20}, {AT_CLAW, AF_PLAIN, 15},
      {AT_CLAW, AF_PLAIN, 15}, AT_NO_ATK },
    8, 960,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_TROLL, MONS_TROLL, MH_UNDEAD, 10,
...
// Semi-unique in the moon base wizlab
{
    ...
    10, MONS_TROLL, MONS_MOON_TROLL, MH_UNDEAD, 140,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 25},
      {AT_CLAW, AF_PLAIN, 25}, AT_NO_ATK },
    18, 990,
...
// The Big Bad
// TODO: Make this more interesting - not just HARD, but intersting to fight
{
    MONS_ZOT, 'Z', RED, "Zot",
    M_UNIQUE | M_STATIONARY | M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES
        | M_UNBLINDABLE | M_SPEAKS | M_FEMALE,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_NEG, 2) | MR_RES_ELEC | MR_RES_ACID
        | MR_RES_STICKY_FLAME | MR_RES_PETRIFY | MR_RES_POISON
        | MR_RES_ROTTING | MR_RES_STEAM | MR_RES_STEAM | MR_RES_DAMNATION,
    18, MONS_ORB_OF_FIRE, MONS_ZOT, MH_HOLY, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    25, 2345,
    20, 20, MST_ZOT, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_MISC,
    {TILEP_MONS_ZOT, TVARY_RANDOM}, TILE_ERROR
},
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 1820,
    20, 0, MST_ROXANNE, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
// human uniques
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    20, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 10,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 200,
    0, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    125, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD | MH_EVIL, 10,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 95,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    50, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 10,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    15, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 440,
    0, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    20, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 400,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    20, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 100,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 840,
...

{
    ...
    MR_NO_FLAGS,
    15, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 660,
    0, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    20, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 60,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 630,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    15, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 80,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 1040,
...

{
    ...
    MR_NO_FLAGS,
    15, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 100,
...

{
    ...
    MR_NO_FLAGS,
    18, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 100,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1200,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    15, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 140,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    22, 1650,
...

{
    ...
    13, MONS_HUMAN, MONS_HUMAN, MH_UNDEAD, 120,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1890,
