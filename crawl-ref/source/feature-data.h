...
PORTAL_ENTRANCE(DNGN_ENTER_DEMON, "gateway to the Demon Dimensions", "enter_demon", RED),
PORTAL_EXIT(DNGN_EXIT_DEMON, "gateway back to the Demon Dimensions", "exit_demon", LIGHTRED),
...
BRANCH_ENTRANCE(DNGN_ENTER_DWARF, "staircase to the Dwarven Hell", "enter_dwarven_hell"),
BRANCH_ENTRANCE(DNGN_ENTER_FOREST, "staircase to the Enchanted Forest", "enter_forest"),
BRANCH_ENTRANCE(DNGN_ENTER_BLADE, "staircase to the Hell of Blades", "enter_hell_of_blades"),
BRANCH_EXIT(DNGN_EXIT_DWARF, "staircase back to the Vaults", "exit_dwarven_hell"),
BRANCH_EXIT(DNGN_EXIT_FOREST, "staircase back to the Vaults", "exit_forest"),
BRANCH_EXIT(DNGN_EXIT_BLADE, "staircase back to the Vaults", "exit_hell_of_blades"),
...
ALTAR(DNGN_ALTAR_XOM, "shimmering altar of Loki", "altar_xom", ETC_RANDOM),
ALTAR(DNGN_ALTAR_VEHUMET, "enticing altar of Nath-Horthath", "altar_vehumet", ETC_VEHUMET),
ALTAR(DNGN_ALTAR_OKAWARU, "iron altar of Ghatanothoa", "altar_okawaru", CYAN),
ALTAR(DNGN_ALTAR_MAKHLEB, "burning altar of Paimon", "altar_makhleb", ETC_FIRE),
ALTAR(DNGN_ALTAR_SIF_MUNA, "blood red altar of Karakal", "altar_sif_muna", RED),
ALTAR(DNGN_ALTAR_TROG, "bloodstained altar of Ammut", "altar_trog", RED),
...
ALTAR(DNGN_ALTAR_FEDHAS, "decaying altar of Ei'lor", "altar_fedhas", GREEN),
ALTAR(DNGN_ALTAR_CHEIBRIADOS, "snail-covered altar of Cheibriados", "altar_cheibriados", LIGHTCYAN),
ALTAR(DNGN_ALTAR_ASHENZARI, "shattered altar of Farfarello", "altar_ashenzari", LIGHTRED),
ALTAR(DNGN_ALTAR_DITHMENOS, "shadowy altar of Dithmenos", "altar_dithmenos", ETC_DITHMENOS),
ALTAR(DNGN_ALTAR_GOZAG, "opulent altar of Mara", "altar_gozag", ETC_GOLD), // for the Gold God!
ALTAR(DNGN_ALTAR_QAZLAL, "stormy altar of Qazlal", "altar_qazlal", ETC_ELEMENTAL),
ALTAR(DNGN_ALTAR_RU, "sacrificial altar of Yig", "altar_ru", BROWN),
ALTAR(DNGN_ALTAR_ECUMENICAL, "faded altar of an unknown god", "altar_ecumenical", ETC_DARK),
ALTAR(DNGN_ALTAR_PAKELLAS, "oddly glowing altar of Valak", "altar_pakellas", ETC_PAKELLAS),
ALTAR(DNGN_ALTAR_USKAYAW, "hide-covered altar of Lamashtu", "altar_uskayaw", ETC_INCARNADINE),
ALTAR(DNGN_ALTAR_HEPLIAKLQANA, "hazy altar of Pazuzu", "altar_hepliaklqana", LIGHTGREEN),
ALTAR(DNGN_ALTAR_WU_JIAN, "gory altar of Sobek", "altar_wu_jian", ETC_WU_JIAN),
