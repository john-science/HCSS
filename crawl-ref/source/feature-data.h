...
ALTAR(DNGN_ALTAR_SIF_MUNA, "blood red altar of Sif Muna", "altar_sif_muna", RED),
...
ALTAR(DNGN_ALTAR_FEDHAS, "decaying altar of Fedhas", "altar_fedhas", GREEN),
...
ALTAR(DNGN_ALTAR_WU_JIAN, "gory altar of the Wu Jian Council", "altar_wu_jian", ETC_WU_JIAN),
